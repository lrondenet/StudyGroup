...
class _GroupDetailState extends State<GroupDetail> {
  List<Message> messages = [
    Message(
      sender: User(name: 'bill'),
      text: 'I\'m doing great bro!',
      time: '8:50PM'
    ),
    Message(
      sender: User(name: 'john'),
      text: 'Greetings feelow class members!? I hope life is going great!How are you?',
      time: '8:50PM'
    ),
    Message(
      sender: User(name: 'marcus'),
        ...
        child: Container(
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return buildMessage(messages[index], isMe, widget.bgColor, textColor);
            },
          )
        ),
      ),
...
buildMessage(Message msg, bool isMe, Color bgColor, Color textColor) => Container(
  child: Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: <Widget>[
      Text(
        isMe ? 'You said:' : '${msg.sender.name} said:',
        style: TextStyle(
          fontSize: 10,
